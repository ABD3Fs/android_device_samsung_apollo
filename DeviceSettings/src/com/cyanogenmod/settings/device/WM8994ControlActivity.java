...
public class WM8994ControlActivity extends PreferenceActivity /*implements
    ...
    private static final String TAG = "G3Parts_WM8994ControlSound";

    public static final String KEY_EXPANSION_GAIN = "expansion_gain";
    private ListPreference mStereoExpansionGain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStereoExpansionGain = (ListPreference) findPreference(KEY_EXPANSION_GAIN);
        mStereoExpansionGain.setOnPreferenceChangeListener(new StereoExpansionGain());
    ...
    public static void restore(Context context) {
        ...
        for(iPosition=0;iPosition<iTotalOptions;iPosition++) {
                if (isSupported(aOptionControl[iPosition][0])) {
                        ...
                        if (iPosition == 2) {
				Utils.writeValue(aOptionControl[iPosition][0], sharedPrefs.getBoolean(aOptionControl[iPosition][1], false));
			} else {
